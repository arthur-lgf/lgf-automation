...
def test_parse_salesanalysis_default_and_periods():
    r = sc.parse_command("/salesanalysis", "", "C7")
    assert r.workflow == "sales-analysis-ondemand.yml"
...
def test_handle_dispatches_salesanalysis():
    body = _form(command="/salesanalysis", text="monthly", channel_id="C55")
    ts = "1700000000"
    calls = []
    resp = sc.handle_slash_request(
        raw_body=body,
